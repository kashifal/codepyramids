    ...
    <div className="relative w-full min-h-[60vh] px-4 md:px-6 xl:px-4 flex items-center justify-center mt-12 mb-12">
      <div className="w-[1424px] mx-auto   h-full  flex items-center justify-between md:flex-row flex-col-reverse">
        ...
        <div className="w-full   md:w-6/12 h-full flex  items-start justify-center flex-col">
          ...
          <h1 className="text-[24px] md:text-[35px] 	 text-left	md:text-left xl:text-[40px] text-black  font-black leading-[32px] md:leading-[40px] xl:leading-[60px] ">
            Take the next step
            with eduqode.
          </h1>
          ...
          <div className="mt-6 btns">
            <Link to="/register">
              <button className="px-5 py-2  text-sm  normal-case rounded-none border-custom-pink bg-custom-pink text-white ">
                Join now
              </button>
            </Link>
