          ...
          >
            {coursesData.map((item, index) => (
              <SwiperSlide key={index} className="swiper-slide">
                <div className="absolute z-40 text-sm font-medium text-white min-w-16 px-2 h-6 top-2 left-2 rounded-sm flex items-center justify-center bg-[rgba(222,0,165,.8)] border-2 border-white">
                  $45 | Lifetime access
                </div>
                <div className="relative h-full w-full flex justify-between flex-col card-data">
                  ...
                  <div className="w-full h-[60%] bg-custom-dark px-4 text-left text-white py-14 info">
                    ...
                    <button className="px-2 py-[4px] text-sm font-light mt-2 border-2 border-custom-primary   text-custom-primary rounded  ml-0">
